...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_COLEMAK] = LAYOUT_ortho_4x12(
    ...
    TT(_ARROW)      , KC_NO , KC_NO        , KC_LALT , KC_LGUI , LT(1, KC_SPC) , LT(1, KC_SPC) , KC_ENT , KC_BSLS , KC_NO  , KC_NO   , KC_NO) ,
  ...
  [_ARROW] = LAYOUT_ortho_4x12(
    ...
    KC_TRNS      , KC_TRNS , TO(_COLEMAK) , KC_MS_BTN1 , KC_MS_BTN2 , KC_TRNS , KC_LEFT , KC_DOWN , KC_UP   , KC_RGHT , KC_TRNS , KC_TRNS    ,
