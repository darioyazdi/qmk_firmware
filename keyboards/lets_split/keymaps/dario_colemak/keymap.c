...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_COLEMAK] = LAYOUT_ortho_4x12(
    ...
    KC_LCTL         , KC_A  , LT(2, KC_R)  , KC_S    , KC_T    , KC_D          , KC_H          , KC_N   , KC_E    , KC_I   , KC_O    , KC_QUOT         ,
    LSFT_T(KC_LBRC) , KC_Z  , KC_X         , KC_C    , KC_V    , KC_B          , KC_K          , KC_M   , KC_COMM , KC_DOT , KC_SLSH , RSFT_T(KC_RBRC) ,
    TO(_ARROW)      , KC_NO , KC_NO        , KC_LALT , KC_LGUI , LT(1, KC_SPC) , LT(1, KC_SPC) , KC_ENT , KC_BSLS , KC_NO  , KC_NO   , KC_NO) ,
  ...
  [_ARROW] = LAYOUT_ortho_4x12(
    KC_TRNS      , KC_TRNS , KC_TRNS , KC_TRNS    , KC_WH_U    , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , RESET      ,
    KC_TRNS      , KC_TRNS , KC_MPRV , KC_MS_BTN1 , KC_MS_BTN2 , KC_TRNS , KC_LEFT , KC_DOWN , KC_UP   , KC_RGHT , KC_TRNS , KC_TRNS    ,
    KC_TRNS      , KC_TRNS , KC_TRNS , KC_TRNS    , KC_WH_D    , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS    ,
    TO(_COLEMAK) , KC_TRNS , KC_TRNS , KC_TRNS    , KC_TRNS    , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS)};
